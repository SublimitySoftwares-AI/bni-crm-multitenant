        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-6 mb-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="p-6">
                    ...
                    <div class="mt-2 text-3xl font-semibold text-blue-600">{{ $stats['total_leads'] }}</div>
                </div>
            </div>
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="p-6">
                    <div class="text-sm font-medium text-gray-500">Total Exhibitions</div>
                    <div class="mt-2 text-3xl font-semibold text-purple-600">{{ $stats['total_exhibitions'] }}</div>
                </div>
            </div>
        </div>
