                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    @auth
                        ...
                        @else
                            ...
                            <x-nav-link :href="route('tenant.leads.index')" :active="request()->routeIs('tenant.leads.*')">
                                {{ __('Leads') }}
                            </x-nav-link>
                            <x-nav-link :href="route('tenant.exhibitions.index')" :active="request()->routeIs('tenant.exhibitions.*')">
                                {{ __('Exhibitions') }}
                            </x-nav-link>
                        @endif
                    @endauth
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                @auth
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <!-- Profile link removed - route not defined -->
                            <!-- Authentication -->
